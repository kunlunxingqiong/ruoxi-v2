...
class TestBloodPressureAPI:
    ...
    def test_create_bp_record_success(self, client, auth_headers, test_user):
        ...
        response = client.post(
            ...
            json={"systolic": 120, "diastolic": 80, "pulse": 75},
        )
    ...
    def test_create_bp_record_crisis_alert(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/health/blood-pressure",
            headers=auth_headers,
            json={"systolic": 185, "diastolic": 125, "pulse": 95},
        )
    ...
    def test_create_bp_record_invalid_systolic(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/health/blood-pressure",
            headers=auth_headers,
            json={"systolic": 300, "diastolic": 80},
        )
    ...
    def test_get_bp_records(self, client, auth_headers, test_bp_records):
        """测试获取血压记录列表"""
        response = client.get("/api/v1/health/blood-pressure", headers=auth_headers)
    ...
    def test_get_bp_statistics(self, client, auth_headers, test_bp_records):
        """测试获取血压统计"""
        response = client.get(
            "/api/v1/health/blood-pressure/statistics", headers=auth_headers
        )
    ...
    def test_get_bp_trends(self, client, auth_headers, test_bp_records):
        """测试获取血压趋势"""
        response = client.get(
            "/api/v1/health/blood-pressure/trends", headers=auth_headers
        )
...
class TestGlucoseAPI:
    ...
    def test_create_glucose_record_hyper(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/health/glucose",
            headers=auth_headers,
            json={"value": 17.5, "unit": "mmol/L", "meal_type": "post_meal"},
        )
    ...
    def test_create_glucose_record_hypo(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/health/glucose",
            headers=auth_headers,
            json={"value": 3.2, "unit": "mmol/L", "meal_type": "fasting"},
        )
    ...
    def test_get_glucose_statistics(self, client, auth_headers, test_glucose_records):
        """测试血糖统计"""
        response = client.get("/api/v1/health/glucose/statistics", headers=auth_headers)
...
class TestWeightAPI:
    ...
    def test_create_weight_record(self, client, auth_headers, test_user):
        ...
        response = client.post(
            ...
            headers=auth_headers,
            json={"weight_kg": 70, "record_type": "morning", "note": "早晨空腹"},
        )
    ...
    def test_weight_bmi_calculation(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/health/weight", headers=auth_headers, json={"weight_kg": 80}
        )
...
class TestSleepAPI:
    ...
    def test_create_sleep_record(self, client, auth_headers):
        ...
        response = client.post(
            "/api/v1/health/sleep",
            headers=auth_headers,
            json={"bed_time": bed_time, "wake_time": wake_time, "sleep_quality": 85},
        )
    ...
    def test_sleep_efficiency_calculation(
        self, client, auth_headers, test_sleep_records
    ):
        """测试睡眠效率计算"""
        response = client.get("/api/v1/health/sleep/statistics", headers=auth_headers)
...
class TestHeartRateAPI:
    ...
    def test_create_hr_record(self, client, auth_headers):
        ...
        response = client.post(
            ...
            headers=auth_headers,
            json={"bpm": 75, "activity": "resting", "note": "静息心率"},
        )
...
class TestRecordsSummaryAPI:
    ...
    def test_get_records_summary(
        self, client, auth_headers, test_bp_records, test_glucose_records
    ):
        """测试获取记录汇总"""
        response = client.get("/api/v1/health/records/recent", headers=auth_headers)
