...
class TestHealthReportAPI:
    ...
    def test_generate_weekly_report(self, client, auth_headers, test_bp_records):
        ...
        response = client.post(
            ...
            json={"report_type": "weekly", "include_charts": True},
        )
    ...
    def test_generate_monthly_report(
        ...
        response = client.post(
            "/api/v1/reports/generate",
            headers=auth_headers,
            json={"report_type": "monthly", "include_charts": True},
        )
    ...
    def test_get_weekly_report_quick(self, client, auth_headers, test_bp_records):
        """测试快捷周报接口"""
        response = client.get("/api/v1/reports/weekly", headers=auth_headers)
...
class TestHealthScoreAPI:
    ...
    def test_get_health_score(
        ...
        """测试获取健康评分"""
        response = client.get("/api/v1/reports/health-score", headers=auth_headers)
    ...
    def test_get_report_summary(self, client, auth_headers, test_bp_records):
        """测试获取报告摘要"""
        response = client.get("/api/v1/reports/summary?days=30", headers=auth_headers)
    ...
    def test_get_trends_bp(self, client, auth_headers, test_bp_records):
        """测试血压趋势"""
        response = client.get(
            "/api/v1/reports/trends?metric=bp&days=30", headers=auth_headers
        )
    ...
    def test_get_trends_weight(self, client, auth_headers):
        """测试体重趋势"""
        response = client.get(
            "/api/v1/reports/trends?metric=weight&days=30", headers=auth_headers
        )
    ...
    def test_get_trends_glucose(self, client, auth_headers, test_glucose_records):
        """测试血糖趋势"""
        response = client.get(
            "/api/v1/reports/trends?metric=glucose&days=30", headers=auth_headers
        )
    ...
    def test_get_trends_invalid_metric(self, client, auth_headers):
        """测试无效指标趋势"""
        response = client.get(
            "/api/v1/reports/trends?metric=invalid&days=30", headers=auth_headers
        )
...
class TestRecommendationsAPI:
    ...
    def test_get_recommendations(
        ...
        """测试获取个性化建议"""
        response = client.get(
            "/api/v1/reports/recommendations?days=30", headers=auth_headers
        )
    ...
    def test_recommendations_with_high_bp(self, client, auth_headers, test_bp_records):
        """测试高血压建议"""
        response = client.get("/api/v1/reports/recommendations", headers=auth_headers)
...
class TestReportsAuthorization:
    ...
    def test_generate_report_require_auth(self, client):
        """测试生成报告需要认证"""
        response = client.post(
            "/api/v1/reports/generate", json={"report_type": "weekly"}
        )
