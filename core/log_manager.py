...
class LogManager:
    ...
    @classmethod
    def log_api_request(
        cls, method: str, path: str, status_code: int, duration: float, **kwargs
    ):
        """记录API请求日志"""
    ...
    def log_ai_interaction(
        cls, model: str, tokens_used: int, duration: float, success: bool, **kwargs
    ):
        """记录AI交互日志"""
        logger = cls.get_logger()
    ...
    def log_memory_operation(
        cls, operation: str, memory_type: str, memory_id: Optional[str] = None, **kwargs
    ):
        """记录记忆操作日志"""
        logger = cls.get_logger()
        logger.info(
...
def log_ai_interaction(
    model: str, tokens_used: int, duration: float, success: bool, **kwargs
):
    """记录AI交互"""
...
def log_memory_operation(
    operation: str, memory_type: str, memory_id: Optional[str] = None, **kwargs
):
    """记录记忆操作"""
