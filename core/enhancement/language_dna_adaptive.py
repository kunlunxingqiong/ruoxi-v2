...
class AdaptiveLanguageGenerator:
    ...
    def generate_adaptive_text(self, 
                              content: str,
    ...
    def _adjust_dna_by_emotion(self, dna: LanguageDNA, 
                               emotional_state: Dict) -> LanguageDNA:
        """根据情感调整DNA"""
        ...
        if mood == "shy":
            ...
            adjusted.pause_pattern = [p * 1.5 for p in adjusted.pause_pattern]  # 更长停顿
