...
class NotificationService:
    ...
    async def create_notification(
        ...
        if channels is None:
            ...
            if priority in [NotificationPriority.CRITICAL, NotificationPriority.HIGH]:
                channels.extend([NotificationChannel.WEBSOCKET, NotificationChannel.PUSH])
    ...
    async def _send_websocket(self, notification: Notification) -> bool:
        ...
        try:
            ...
            sent = await connection_manager.send_to_user(
    ...
    def get_unread_count(self, user_id: str) -> int:
        ...
        return sum(
            1 for n in self._notifications[user_id]
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "read_rate": f"{(total_notifications - total_unread) / total_notifications:.1%}" if total_notifications > 0 else "N/A"
        }
