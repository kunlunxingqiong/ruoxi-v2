        ...
        return {
            ...
            "comparison": {
                ...
                "avg_change_pct": round(
                    (series2.avg_value - series1.avg_value) / series1.avg_value * 100, 1
                ) if series1.avg_value else 0,
                "trend": "improved" if self._is_improved(series1.name, series2.avg_value, series1.avg_value) else "worsened" if series2.avg_value != series1.avg_value else "stable"
            }
        }
