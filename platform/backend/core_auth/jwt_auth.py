...
class JWTAuthManager:
    ...
    def __init__(self):
        # 从配置获取密钥或使用默认
        self.secret_key = config.get("security.jwt_secret", "your-secret-key-change-in-production")
        self.algorithm = config.get("security.jwt_algorithm", "HS256")
        self.access_token_expire_minutes = config.get("security.access_token_expire_minutes", 1440)  # 24小时
