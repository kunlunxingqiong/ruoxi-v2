...
def upgrade() -> None:
    ...
    bloodpressurecategory = sa.Enum('NORMAL', 'ELEVATED', 'STAGE1', 'STAGE2', 'CRISIS', name='bloodpressurecategory')
    bloodpressurecategory.create(op.get_bind())
    
    glucosemealtype = sa.Enum('FASTING', 'BEFORE_MEAL', 'AFTER_MEAL', 'BEFORE_BED', 'RANDOM', name='glucosemealtype')
    ...
    op.create_index('ix_bp_user_measured', 'blood_pressure_records', ['user_id', 'measured_at'])
