...
from core.rate_limit.rate_limiter import rate_limiter, RateLimitExceeded
from core.monitoring.metrics import metrics_collector, api_metrics
from core.audit.audit_logger import audit_logger, AuditCategory, AuditLevel
...
async def clear_cache(
    ...
    return {
        "success": True,
        "message": f"缓存已清除 (级别: {level or 'all'})"
    }
