...
from core.emotion.emotion_analyzer import (
    emotion_analyzer,
    EmotionState,
    CrisisLevel
)
...
async def analyze_emotion(
    ...
    **示例:**
    ...
    return EmotionAnalysisResponse(
        ...
        emotion_cn=emotion_names.get(state.primary_emotion.value, state.primary_emotion.value),
...
async def get_emotional_support(
    ...
    **示例:**
    ...
    # 选择回复
    import random
    response_text = random.choice(responses.get(state.primary_emotion, [
        "🌸 我在听，想聊什么都可以~"
    ]))
    ...
    return EmotionalSupportResponse(
        ...
        follow_up=random.choice(strategy.follow_up_questions) if strategy.follow_up_questions else "还有什么想聊的吗？",
