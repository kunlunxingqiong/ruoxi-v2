...
from core.services.user_preference_service import (
    UserPreferenceService, NotificationPreferenceService,
...
async def get_today_tasks(
    ...
    try:
        ...
        return {
            ...
            "completion_rate": dashboard.get("today_overview", {}).get("completion_status")
        }
    except Exception as e:
...
async def get_dashboard_cards(
    ...
    return {
        "success": True,
        "cards": service.get_dashboard_cards()
    }
